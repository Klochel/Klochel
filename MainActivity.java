...
public class MainActivity extends AppCompatActivity {
    ...
    class Wrapper {
        ...
        // Creating file reader for text file
        public class onFileReader extends textFiles(new ImageDownloader) {
            final Context context = MainActivity.this;
            String textFileName = "";

            public void setString(String newName) { imagesLayout = newTextFile; }
